...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Scrolltype', 'Changes the Scrolltype -\nValue 1 or 2:\n(Value 1)\'off\' is to switch to Upscroll, \'on\' is to switch to Downscroll\n(Value 2)\'off\' is to switch to Sidescroll, \'on\' is to switch to Middlescroll\n\'swap\' is to switch between them\nExtras:\n\'default\' on either value will to switch to Default Scrolltype of that value']
	];
