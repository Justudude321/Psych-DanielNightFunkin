...
class PlayState extends MusicBeatState
{
	...
	function eventPushed(event:EventNote) {
		switch(event.event) {
			...
			case 'Philly Glow':
				if (WeekData.getWeekFileName() == 'week3' && curStage == 'philly') { // PLEASE SHUT THE FUCK UP - again??
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'Philly Glow':
				if (WeekData.getWeekFileName() == 'week3' && curStage == 'philly') {// hey! no "shut the fuck up." Nice
