...
function onCreate()
   ...
   makeLuaText('JukeBoxSubText', 'theinnuendo & saster - burning in hell', 0-IntroTagWidth, 60)
    ...
    setTextFont('JukeBoxSubText', 'Comic Sans UT.TTF');
...
function onSongStart()
	...
	doTweenX('MoveInFour', 'JukeBoxSubText', 530, 1, 'CircInOut')
