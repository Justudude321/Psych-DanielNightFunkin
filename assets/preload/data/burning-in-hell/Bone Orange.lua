function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Bone Orange' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'NOTE_Orange'); --Change texture
